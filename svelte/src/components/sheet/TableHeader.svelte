<!-- TableHeader.svelte -->
<script lang="ts">
    import { filterByProduct, filterByCustomer, filterBySalesperson, filteredData, show_id, selectedProduct, selectedCustomer, selectedSalesperson, clearFilters } from '../../lib/filtering';
  </script>
